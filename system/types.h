...
//            IF<(Traits<System>::LIFE_SPAN * 1000000ULL <= MAX_UNSIGNED_LONG_LONG), unsigned long long Time_Base;
typedef long long int Time_Base;
...
enum Infinity : Time_Base { INFINITE = MAX_LONG_LONG_INT/*-1U*/ };
