...
// Trace
enum Debug_Log {LOGGER = 5};

template<typename T>
inline Select_Debug<(Traits<T>::debugged && Traits<Debug>::logger)>
db(Debug_Log l)
{
    Select_Debug<(Traits<T>::debugged && Traits<Debug>::logger)>() << begl;
    return Select_Debug<(Traits<T>::debugged && Traits<Debug>::logger)>();
}

template<typename T1, typename T2>
inline Select_Debug<((Traits<T1>::debugged || Traits<T2>::debugged) && Traits<Debug>::logger)>
db(Debug_Log l)
{
    Select_Debug<((Traits<T1>::debugged || Traits<T2>::debugged) && Traits<Debug>::logger)>() << begl;
    return Select_Debug<((Traits<T1>::debugged || Traits<T2>::debugged) && Traits<Debug>::logger)>();
}
